...
- Cadastrar, visualizar e editar produtos;  
- Controlar o estoque de forma simples;  
...
| Etapa | Descrição | Mês |
|-------|------------|------|
| 1 | Levantamento de requisitos e telas | 1 |
| 2 | Criação das páginas HTML e CSS | 2 |
| 3 | Implementação em JavaScript | 3 |
